...
> = {
  ...
  en: {
    ...
    returnP2:
      "Returns or exchanges at the customer’s request may be accepted for unopened items. Please contact us in advance about shipping costs and other details.",
  ...
  ko: {
    ...
    returnP2:
      "고객 사유의 반품·교환은 미개봉품에 한해 받을 수 있는 경우가 있습니다. 배송료 부담 등 자세한 내용은 사전에 문의해 주세요.",
    contactTitle: "문의",
    contactP1:
